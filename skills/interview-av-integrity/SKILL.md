...
description: 日本語のGoogle Meet系面談録画（H.264、1920×1080、24fps CFR、AAC 48kHz）の音声・映像整合性を、両唇破裂音 /p,b/ の音響開放、口唇閉鎖・開放、話者内外の対照、盲検レビューで検証し、再現可能な注釈付き比較動画まで作成する。動画面談の口と音声のずれ、閉鎖欠如、A/V integrity の分析依頼で使用する。通常の動画編集・文字起こしだけの依頼、別形式への未校正自動適用、日本語以外の音素抽出、本人特定、人物属性・所在地・所属の推定には使用しない。
---
